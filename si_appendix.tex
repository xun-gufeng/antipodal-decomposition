...
\textbf{Linear vs.\ quadratic regression.} With only eight data points, a quadratic model ($\text{amp} \sim \text{lat} + \text{lat}^2$) yields $R^2 = 0.924$ ($\Delta R^2 = 0.006$) at the cost of an additional parameter; the adjusted $R^2$ decreases from 0.904 (linear) to 0.893 (quadratic), indicating overfitting~(13). The quadratic model also introduces a physically implausible curvature in the latitude--amplitude relationship over the observed range.

% ══════════════════════════════════════════
\subsection*{9. Comparison with Data-Driven Climate Regionalization}
...
% ══════════════════════════════════════════
\subsection*{10. Monthly Complementarity}
...
% ══════════════════════════════════════════
\subsection*{11. Multi-Variable Complementarity}
